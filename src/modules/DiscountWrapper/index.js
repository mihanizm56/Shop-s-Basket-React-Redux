      ...
      <div className="promo-enter">
        ...
        <div className="input-block">
          ...
          <button
            ...
            style={discount && userItems ? { backgroundColor: "#FF6D00" } : {}}
          >
            Применить
          </button>
        </div>
        ...
        <div className="sum-display">
          ...
          <div className="second-text-block">
            ...
            <span className="second-text-block-text second-text-block__result-value">
              {discount && userItems.length
                ? checkSumOfItems(userItems) - discountValue
                : checkSumOfItems(userItems)}{" "}
              руб.
            </span>
          </div>
        </div>
